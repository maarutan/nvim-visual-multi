...
augroup VM_reset_theme
  au!
  " Автоматическая смена темы при изменении `background`
...
let s:Themes._light = ['autolight', 'sand', 'paper', 'lightblue1', 'lightblue2']
let s:Themes._dark = ['auto', 'iceblue', 'ocean', 'neon', 'purplegray', 'nord', 'codedark', 'spacegray', 'olive']
